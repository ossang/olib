...
/**
 *  GetAdGroup bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetAdGroup implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getAdGroup", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getAdGroup", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetAdGroup parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            GetAdGroup object = new GetAdGroup();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getAdGroup".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetAdGroup) net.daum.clix.api.group.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
