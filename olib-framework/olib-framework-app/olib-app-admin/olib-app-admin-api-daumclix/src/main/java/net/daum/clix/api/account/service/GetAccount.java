...
/**
 *  GetAccount bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetAccount implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
         ...
         */
        public static GetAccount parse(javax.xml.stream.XMLStreamReader reader)
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getAccount".equals(type)) {
                            ...
                            return (GetAccount) net.daum.clix.api.account.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
