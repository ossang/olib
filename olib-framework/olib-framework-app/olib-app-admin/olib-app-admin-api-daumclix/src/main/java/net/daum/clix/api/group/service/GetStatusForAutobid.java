...
/**
 *  GetStatusForAutobid bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetStatusForAutobid implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = getStatusForAutobid
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getStatusForAutobid", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getStatusForAutobid", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetStatusForAutobid parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetStatusForAutobid object = new GetStatusForAutobid();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getStatusForAutobid".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetStatusForAutobid) net.daum.clix.api.group.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
