...
/**
 *  GetAccountsByPage bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetAccountsByPage implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = getAccountsByPage
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getAccountsByPage", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getAccountsByPage", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetAccountsByPage parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetAccountsByPage object = new GetAccountsByPage();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getAccountsByPage".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetAccountsByPage) net.daum.clix.api.account.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                    ...
                    object.setArg0(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            content));
                ...
                if ((reader.isStartElement() &&
                    ...
                    object.setArg1(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            content));
