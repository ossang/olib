...
/**
 *  GetAccountBalance bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetAccountBalance implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getAccountBalance", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getAccountBalance", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetAccountBalance parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetAccountBalance object = new GetAccountBalance();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getAccountBalance".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetAccountBalance) net.daum.clix.api.account.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
