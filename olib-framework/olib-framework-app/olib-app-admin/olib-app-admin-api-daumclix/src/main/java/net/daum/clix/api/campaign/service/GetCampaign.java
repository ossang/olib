...
/**
 *  GetCampaign bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetCampaign implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getCampaign", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getCampaign", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetCampaign parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            GetCampaign object = new GetCampaign();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getCampaign".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetCampaign) net.daum.clix.api.campaign.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
