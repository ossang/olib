...
/**
 *  GetStatusForCampaign bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetStatusForCampaign implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getStatusForCampaign", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getStatusForCampaign", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetStatusForCampaign parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetStatusForCampaign object = new GetStatusForCampaign();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getStatusForCampaign".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetStatusForCampaign) net.daum.clix.api.campaign.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
