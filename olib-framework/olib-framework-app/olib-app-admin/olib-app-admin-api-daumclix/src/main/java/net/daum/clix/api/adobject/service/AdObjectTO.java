...
/**
 *  AdObjectTO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class AdObjectTO implements org.apache.axis2.databinding.ADBBean {
    ...
    /**
     * field for AdObjectID
     */
    protected long localAdObjectID;
     ...
     * field for Status
     */
    protected net.daum.clix.api.adobject.service.AdObjectStatus localStatus;
     ...
     * @return long
     */
    public long getAdObjectID() {
        return localAdObjectID;
    }

    /**
     * Auto generated setter method
     * @param param AdObjectID
     */
    public void setAdObjectID(long param) {
        this.localAdObjectID = param;
    }
    ...
    /**
     * Auto generated getter method
     * @return net.daum.clix.api.service.AdObjectStatus
     */
    public net.daum.clix.api.adobject.service.AdObjectStatus getStatus() {
        return localStatus;
    }
     ...
     * @param param Status
     */
    public void setStatus(net.daum.clix.api.adobject.service.AdObjectStatus param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":adObjectTO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "adObjectTO", xmlWriter);
            }
        }
        ...
        namespace = "";
        writeStartElement(null, namespace, "adObjectID", xmlWriter);

        if (localAdObjectID == java.lang.Long.MIN_VALUE) {
            throw new org.apache.axis2.databinding.ADBException(
                "adObjectID cannot be null!!");
        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localAdObjectID));
        }
    ...
    public static class Factory {
         ...
         */
        public static AdObjectTO parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            AdObjectTO object = new AdObjectTO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"adObjectTO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (AdObjectTO) net.daum.clix.api.adobject.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "adObjectID").equals(
                            reader.getName())) ||
                        new javax.xml.namespace.QName("", "adObjectID").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "adObjectID" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setAdObjectID(org.apache.axis2.databinding.utils.ConverterUtil.convertToLong(
                            content));
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "siteName").equals(
                            reader.getName())) ||
                        new javax.xml.namespace.QName("", "siteName").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                    ...
                    object.setSiteName(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "status").equals(
                            reader.getName())) {
                    object.setStatus(net.daum.clix.api.adobject.service.AdObjectStatus.Factory.parse(
                            reader));
