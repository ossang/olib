...
public class GetAd implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getAd", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getAd", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static GetAd parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            GetAd object = new GetAd();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getAd".equals(type)) {
                            ...
                            return (GetAd) net.daum.clix.api.ad.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
