...
/**
 *  AccountTO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class AccountTO implements org.apache.axis2.databinding.ADBBean {
     ...
     * @param param Loan
     */
    public void setLoan(boolean param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":accountTO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "accountTO", xmlWriter);
        ...
        namespace = "";
        writeStartElement(null, namespace, "loan", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static AccountTO parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            AccountTO object = new AccountTO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"accountTO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (AccountTO) net.daum.clix.api.account.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "loan").equals(
                            reader.getName())) ||
                        new javax.xml.namespace.QName("", "loan").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "loan" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setLoan(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
                            content));
                ...
                if ((reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "loginID" + "  cannot be null");
                    }
