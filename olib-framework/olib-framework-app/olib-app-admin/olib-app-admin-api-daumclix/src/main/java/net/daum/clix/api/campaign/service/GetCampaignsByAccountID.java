...
/**
 *  GetCampaignsByAccountID bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetCampaignsByAccountID implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getCampaignsByAccountID", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getCampaignsByAccountID", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetCampaignsByAccountID parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetCampaignsByAccountID object = new GetCampaignsByAccountID();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getCampaignsByAccountID".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetCampaignsByAccountID) net.daum.clix.api.campaign.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
