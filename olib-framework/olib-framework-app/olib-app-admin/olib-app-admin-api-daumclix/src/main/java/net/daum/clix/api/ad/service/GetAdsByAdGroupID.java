...
/**
 *  GetAdsByAdGroupID bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetAdsByAdGroupID implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getAdsByAdGroupID", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getAdsByAdGroupID", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetAdsByAdGroupID parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetAdsByAdGroupID object = new GetAdsByAdGroupID();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getAdsByAdGroupID".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetAdsByAdGroupID) net.daum.clix.api.ad.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
