...
/**
 *  GetStatusForAdGroup bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetStatusForAdGroup implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = getStatusForAdGroup
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getStatusForAdGroup", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getStatusForAdGroup", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetStatusForAdGroup parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetStatusForAdGroup object = new GetStatusForAdGroup();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getStatusForAdGroup".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetStatusForAdGroup) net.daum.clix.api.group.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
