...
/**
 *  GetAdGroupByCampaignID bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetAdGroupByCampaignID implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = getAdGroupByCampaignID
    ...
    public void setArg0(long param) {
        ...
        localArg0Tracker = param != java.lang.Long.MIN_VALUE;
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getAdGroupByCampaignID", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getAdGroupByCampaignID", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetAdGroupByCampaignID parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetAdGroupByCampaignID object = new GetAdGroupByCampaignID();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getAdGroupByCampaignID".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetAdGroupByCampaignID) net.daum.clix.api.group.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
