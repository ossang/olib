...
/**
 *  GetAdObjects bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetAdObjects implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getAdObjects", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getAdObjects", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetAdObjects parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetAdObjects object = new GetAdObjects();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getAdObjects".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetAdObjects) net.daum.clix.api.adobject.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
