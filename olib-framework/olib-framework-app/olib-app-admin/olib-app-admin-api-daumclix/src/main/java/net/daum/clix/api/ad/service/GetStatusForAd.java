...
/**
 *  GetStatusForAd bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetStatusForAd implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getStatusForAd", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getStatusForAd", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetStatusForAd parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetStatusForAd object = new GetStatusForAd();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getStatusForAd".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetStatusForAd) net.daum.clix.api.ad.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
