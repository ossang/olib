...
/**
 *  GetAdObject bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetAdObject implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getAdObject", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getAdObject", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetAdObject parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            GetAdObject object = new GetAdObject();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getAdObject".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetAdObject) net.daum.clix.api.adobject.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
